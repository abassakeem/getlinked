            ...
            <Row className="p-0 g-0">
              <Col md={6} className="d-flex flex-column justify-content-center px-5">
                <div className="left-hero-container text-start ">
                  <div className="left-hero d-flex flex-column justify-content-center ">
                    <Image
                      src={star}
                      className="blinking-star star hero-white-star"
                      fluid
                    />
                    <motion.div
                      initial={{
                    ...
                    >
                      <Image
                        fluid
                        src={light}
                        className="hero-light d-none d-md-block"
                      />
                      <h1 className="hero-header mt-5 ">getlinked Tech</h1>
                      <div className="small-bulb position-absolute">
                        <Image src={bulb} className="bulb-img" fluid />
                      </div>
                      <h2 className="hero-header">
                        Hackathon <span>1.0</span>{" "}
                        <Image src={chain} className="chain" fluid />{" "}
                        <Image src={explosion} className="explosion" fluid />
                      </h2>
                    </motion.div>
                    ...
                    <div className="register-btn-container-hero mt-5 mb-5">
                      <Link
                        to="/register"
                        className="nav-btn   register-btn-hero "
                      >
                        Register
                      </Link>
                    </div>
                    <div className="position-relative">
                      <Image
                        src={star1}
                        className="blinking-trans-star star hero-transparent-star "
                        fluid
                      />
                    </div>
                    <div className="timer">
                      ...
                      <span className=" second">
                        00<span className="small-leter-timer">S</span>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <Col md={6} className="p-0 m-0">
                <div className="position-relative ">
                  <Image
                    src={star1}
                    className="blinking-trans-star star hero-man-transparent-star "
                    fluid
                  />
                </div>
                <div className="right-hero ">
                  <div className="man-glasses-img">
                    ...
                    <Image
                      fluid
                      src={light2}
                      className="hero-light2 d-none d-xl-block"
                    />
